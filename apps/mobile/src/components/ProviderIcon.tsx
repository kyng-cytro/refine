...
function AnthropicIcon({ size, color }: { size: number; color: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M13.827 3.52h3.603L24 20h-3.603l-6.57-16.48zm-3.654 0H6.57L0 20h3.603l1.357-3.415h6.857L13.174 20h3.603l-6.604-16.48zm-1.518 9.99 2.152-5.407 2.15 5.407H8.655z"
        fill={color}
      />
    </Svg>
  )
...
export default function ProviderIcon({ provider, size = 20, color = "#000" }: Props) {
  switch (provider) {
    case "openai":
      return <OpenAIIcon size={size} color={color} />
    case "anthropic":
      return <AnthropicIcon size={size} color={color} />
    case "google":
