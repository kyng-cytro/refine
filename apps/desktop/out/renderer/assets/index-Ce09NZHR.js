...
const Button = reactExports.forwardRef(
  ({ variant = "filled", className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ref,
      className: cn(
...
const offset = (options2, deps) => {
  const result = offset$1(options2);
  return {
    name: result.name,
    fn: result.fn,
...
const limitShift = (options2, deps) => {
  const result = limitShift$1(options2);
  return {
    fn: result.fn,
    options: [options2, deps]
  };
...
function Dialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root$2, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Portal$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { className: "fixed inset-0 z-50 bg-scrim/40" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Content$1,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { className: "text-headline-small text-on-surface", children: title }),
          description && /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { className: "mt-2 text-body-medium text-on-surface-variant", children: description }),
          children && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children }),
          actions && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex justify-end gap-2", children: actions })
        ]
      }
    )
  ] }) });
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          className: cn(
            ...
            error ? "border-error focus:border-error" : "border-outline focus:border-primary focus:ring-1 focus:ring-primary"
          ),
          ...props
        }
      ),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-body-small text-error", children: error })
    ] });
  }
);
...
const OutlinedTextArea = reactExports.forwardRef(({ label, error, className, id: idProp, ...props }, ref) => {
  const generatedId = reactExports.useId();
  const id = idProp ?? generatedId;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
